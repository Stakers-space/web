class GnoBeaconChainData {
    constructor() {
        // data structure
        this.id = null;
        this.partitionKey = "gno-beaconchain"; // do I have already data in db?
        this.day = null;
        this.timestamp = null;
    ...
    ConvertToChartsArray(beaconchainArr, startIndex = 0){
        ...
        for(var i=startIndex;i<arrSize;i++){
            ...
            chartsArray.stakedTokens.push(dayData.stakedGno);
            ...
            chartsArray.stakedTokens_change.push(dayData.stakedGno - ((i === 0) ? 0 : beaconchainArr[i - 1].stakedGno));
...
module.exports = GnoBeaconChainData;