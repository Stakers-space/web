function BeaconchainHoldingsDistributionChart(){
    console.log("[WalletBalance chart] registered");
    this.elementId = 'beaconchainbalance_chart';
...
BeaconchainHoldingsDistributionChart.prototype.Init = function(){
    var app = this;
...
BeaconchainHoldingsDistributionChart.prototype.ConfigurateChart = function(){
    // convert to array

    var chartdata = {
        labels: beaconchain_distribution.holdings,
        datasets: [
            {
                label: 'Validators',
                data: beaconchain_distribution.validators,
...
BeaconchainHoldingsDistributionChart.prototype.OnScaleChange = function(value){
...
BeaconchainHoldingsDistributionChart.prototype.SetData = function(value,cb){

};

new BeaconchainHoldingsDistributionChart();